        ...
        <form>
        	<fieldset>
        		...
        		<div class="question">
					...
					<input class="w-auto sm:w-full bg-gray-100 rounded mb-2 border border-gray-400 focus:outline-none focus:border-green-500 text-base py-2 px-4" placeholder="Phone Number" type="tel" name="phone">
				</div>
        		<div class="question">
					<label for="one-page-resume" class="block">1-Page Resume<sup>*</sup></label>
					<input class="w-auto sm:w-full bg-gray-100 rounded mb-2 border border-gray-400 focus:outline-none focus:border-green-500 text-base py-2 px-4" type="file" name="one-page-resume">
				</div>
        		<div class="question">
					<label for="cover-letter" class="block">Cover Letter<sup>*</sup></label>
					<input class="w-auto sm:w-full bg-gray-100 rounded mb-2 border border-gray-400 focus:outline-none focus:border-green-500 text-base py-2 px-4" type="file" name="cover-letter">
				</div>
        		<div class="question">
					<label for="additional-inquiries" class="block">Additional inquiries<sup>*</sup></label>
					<textarea name="additional-inquiries" rows="5" cols="15" class="sm:w-full bg-gray-100 rounded mb-2 border border-gray-400 focus:outline-none focus:border-green-500 text-base py-2 px-4"></textarea>
				</div>
				<div class="submit">
