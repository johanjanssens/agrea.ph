...
<div class="flex flex-col sm:flex-row">
	...
	<aritcle itemscope itemtype="http://schema.org/Article" class="sm:w-3/4 sm:pr-8 sm:py-8 sm:border-t-0 border-t mt-4 pt-4 sm:mt-0">
		<div class="flex flex-wrap w-full mb-20">
			...
			<div class="lg:w-1/2 w-full">
				<img alt="<?= $title ?>" class="rounded object-cover object-center" src="images://programs/garden-classroom/garden-classroom-1.jpg" data-max_width="50%" data-preload="true">
			</div>
		</div>
