...
<div class="flex flex-col sm:flex-row">
	...
	<ktml:images max-width="80%" lazyload="progressive,inline">
		...
		<div itemprop="articleBody">
			...
			<h2 role="heading" aria-level="2" class="font-title text-3xl text-gray-900 dark:text-gray-100 leading-none mb-2">Capacity-Building Framework</h2>
			...
			<h2 role="heading" aria-level="2" class="font-title text-3xl text-gray-900 dark:text-gray-100 leading-none mb-2">Youth in Agriculture and Entrepreneurship Workshops</h2>
			...
			<h2 role="heading" aria-level="2" class="font-title text-3xl text-gray-900 dark:text-gray-100 leading-none mb-2">Beneficiary Demographics</h2>
	...
	<aside role="complimentary" class="sm:w-1/4 sm:mt-0 ms:pt-0 sm:pl-8 sm:pb-8 sm:border-l sm:mt-0 border-gray-300 sm:border-t-0 border-t mt-4 pt-4">
  	<ktml:images max-width="25%" lazyload="progressive,inline">
		...
		<h3 role="heading" aria-level="3" class=" text-gray-900 dark:text-gray-100 font-medium font-title my-4 leading-tight">AGREA Impact Measure: Eight AGREA Thrusts</h3>
		<div class="w-12 h-1 bg-brand rounded mt-2 mb-4"></div>
		...
		<h3 role="heading" aria-level="3" class=" text-gray-900 dark:text-gray-100 font-medium font-title my-4 leading-tight">AGREA Events</h3>
		<div class="w-12 h-1 bg-brand rounded mt-2 mb-4"></div>
		...
		<h3 role="heading" aria-level="3" class=" text-gray-900 dark:text-gray-100 font-medium font-title my-4 leading-tight">AGREA in Action</h3>
		<div class="w-12 h-1 bg-brand rounded mt-2 mb-4"></div>
