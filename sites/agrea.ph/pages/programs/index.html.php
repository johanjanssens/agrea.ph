...
<div class="flex flex-col sm:flex-row">
	...
	<ktml:images max-width="80%" lazyload="progressive,inline">
		<h1 role="heading" aria-level="1" class="sm:text-5xl text-4xl font-medium font-title uppercase mb-2 text-gray-900 dark:text-gray-100 leading-none">The Cultivation of Human Beings</h1>
		...
		<div itemprop="articleBody">
			...
			<h2 role="heading" aria-level="2" class="font-title uppercase text-3xl text-gray-900 dark:text-gray-100 leading-none mb-2">Capacity-Building Framework</h2>
			...
			<h2 role="heading" aria-level="2" class="font-title uppercase text-3xl text-gray-900 dark:text-gray-100 leading-none mb-2">Youth in Agriculture and Entrepreneurship Workshops</h2>
			...
			<h2 role="heading" aria-level="2" class="font-title uppercase text-3xl text-gray-900 dark:text-gray-100 leading-none mb-2">Beneficiary Demographics</h2>
			...
			<div class="bg-lime-100 border border-green-200 text-green-600 p-6 rounded-lg">
				<h3 role="heading" aria-level="3" class="font-title uppercase text-2xl text-green-600 dark:text-gray-100 leading-tight mb-3">Know more about AGREA's social programs</h3>
	...
	<aside role="complimentary" class="sm:w-1/4 sm:mt-0 ms:pt-0 sm:pl-8 sm:pb-8 sm:border-l sm:mt-0 border-gray-300 sm:border-t-0 border-t mt-4 pt-4">
  	<ktml:images max-width="25%" lazyload="progressive,inline">
		...
		<h3 role="heading" aria-level="3" class=" text-gray-900 dark:text-gray-100 font-medium font-title uppercase my-4 leading-tight">AGREA Impact Measure: Eight AGREA Thrusts</h3>
		<div class="w-12 h-1 bg-brand rounded mt-2 mb-4"></div>
		...
		<p>But our farmers and fisher folks are endangered species. Today's challenges in Philippine agriculture include land, climate, and support system for food production.</p>
		<blockquote>
		...
		<?= import('/partials/slider', ['folder' => 'images://slider/8-thrusts', 'max_width' => '25%']); ?>
		<h3 role="heading" aria-level="3" class=" text-gray-900 dark:text-gray-100 font-medium font-title uppercase my-4 leading-tight">AGREA Events</h3>
		<div class="w-12 h-1 bg-brand rounded mt-2 mb-4"></div>
		...
		<h3 role="heading" aria-level="3" class=" text-gray-900 dark:text-gray-100 font-medium font-title uppercase my-4 leading-tight">AGREA in Action</h3>
		<div class="w-12 h-1 bg-brand rounded mt-2 mb-4"></div>
		<div class="bg-gray-100 hover:bg-green-100 p-6 rounded-lg mb-8">
			<a class="text-gray-900 hover:text-gray-600 dark:text-gray-100 dark:hover:text-gray-300" href="<?= route(page('programs/article'), ['slug' => article(150)->slug]) ?>">
				...
				<h2 role="heading" aria-level="2" class="text-lg text-gray-900 dark:text-gray-100 font-medium font-title uppercase mb-4 leading-tight"><?= article(150)->title; ?></h2>
		...
		<div class="bg-gray-100 hover:bg-green-100 p-6 rounded-lg">
			<a class="text-gray-900 hover:text-gray-600 dark:text-gray-100 dark:hover:text-gray-300" href="<?= route(page('programs/article'), ['slug' => article(151)->slug]) ?>">
				...
				<h2 role="heading" aria-level="2" class="text-lg text-gray-900 dark:text-gray-100 font-medium font-title uppercase mb-4 leading-tight"><?= article(151)->title; ?></h2>
				<p class="text-xs text-gray-600 flex items-center">
					<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" class="w-5 h-5 mr-1" stroke="currentColor">
					  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
