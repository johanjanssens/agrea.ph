	...
	<article role="main" itemscope itemtype="http://schema.org/Article" class="sm:w-3/4 sm:pr-8 sm:pt-4 sm:pb-4">
		...
		<div class="flex flex-wrap mt-10">
			<div class="sm:w-1/2 mb-10 px-4 border-box">
				...
				<h3 role="heading" aria-level="3" class="font-medium text-gray-900 mt-6 mb-3"><a href="<?= route(page('news/article'), ['slug' => article(38)->slug]) ?>"><?= article(38)->title ?></a></h3>
	...
	<ktml:images max-width="25%" lazyload="progressive,inline">
		...
		<aside>
			...
			<div class="bg-lime-500 text-gray-900 my-4 px-4 py-2 rounded">
				<h3 role="heading" aria-level="3" class="text-lg text-gray-900 font-medium my-4">SPECIAL GROUP OFFER!!</h3>
