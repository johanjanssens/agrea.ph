	...
	<article itemscope itemtype="http://schema.org/Article" class="sm:w-3/4 sm:pr-8 sm:pt-4 sm:pb-4">
		<div class="flex flex-wrap w-full mb-10">
			...
			<div class="lg:w-1/2 w-full">
				<img alt="<?= $title ?>" class="rounded object-cover object-center" src="images://programs/self-palayance/self-palayance-1.jpg" data-max-width="50%" data-lazyload="progressive">
			</div>
		</div>
