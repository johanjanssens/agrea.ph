...
<div class="flex flex-col sm:flex-row">
	...
	<ktml:images max-width="33%" lazyload="progressive,inline">
		...
		<div role="grid" class="grid xl:grid-cols-3 md:grid-cols-2 gap-8 mb-8">
			...
			<a role="gridcell" class="bg-gray-100 hover:bg-lime-500 transition duration-300 ease-in-out text-gray-900 hover:text-dark-green-500 p-6 rounded-lg" href="<?= route('news/article', ['slug' => $article->slug]) ?>">
