...
<div class="flex flex-col sm:flex-row">
	<article role="main" class="sm:w-3/4 sm:pr-8 sm:pt-4 sm:pb-4">
		...
		<h3 role="heading" aria-level="3" class="font-title text-2xl text-gray-900 leading-tight mb-3">Background</strong></h3>
		...
		<h3 role="heading" aria-level="3" class="font-title text-2xl text-gray-900 leading-tight mb-3">Core Topics</h3>
		<div class="w-12 h-1 bg-green-500 rounded mt-2 mb-4"></div>

		<p>Environment | Economy | Empowerment | Networks</p>

		<h3 role="heading" aria-level="3" class="font-title text-2xl text-gray-900 leading-tight mb-3">Workshop Overview</strong></h3>
		...
		<h3 role="heading" aria-level="3" class="font-title text-2xl text-gray-900 leading-tight mb-3">YSEALI TV for YSEALI GenGR3EN</h3>
		<div class="w-12 h-1 bg-green-500 rounded mt-2 mb-4"></div>
		...
		<h3 role="heading" aria-level="3" class="font-title text-2xl text-gray-900 leading-tight mb-3">YSEALI TV for GenGR3EN Final Episode</h3>
		<div class="w-12 h-1 bg-green-500 rounded mt-2 mb-4"></div>
	  <p>YSEALI GenerationGR3EN has come full circle. Our Top 3 teams from the Workshop traveled all the way to the Philippines and experienced the YSEALI GenerationGR3EN Continued Learning Immersion Program (CLIP). This fifth and last episode of the&nbsp;YSEALITV for YSEALI GenGR3EN lets you hear from the speakers, and the delegates themselves, as they experience immersive learning opportunities all for the objective of creating real-life eco-business.</p>
		...
		<h3 role="heading" aria-level="3" class="font-title text-2xl text-gray-900 leading-tight mb-3">Moving Forward</h3>
	...
	<ktml:images max-width="25%" lazyload="progressive,inline">
		...
		<h4 role="heading" aria-level="4" class="text-gray-900 font-medium font-title my-4">Related Links:</h4>
