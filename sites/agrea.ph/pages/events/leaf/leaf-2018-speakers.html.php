...
<div class="mb-6">
	<ul>
		...
		<li>USec. Ariel Cayanan, Department of Agriculture</li>
		<li>Dr. William D. Dar, InangLupa Movement</li>
		<li>Dr. Mina Gabor, ISST</li>
	</ul>
</div>
<h3 role="heading" aria-level="3" class="font-title uppercase text-2xl text-gray-900 dark:text-gray-100 leading-tight mb-3">Agripreneurship</h3>
<div class="mb-6">
	<ul>
		<li>Steve Benitez, Bo’s Coffee</li>
		<li>Johan Boden, TAEL Partners</li>
		<li>Ma. Gisela Tiongson, Jollibee Group Foundation</li>
		<li>Rei Yoon, Soil and Soul Organic Movement, Inc.</li>
		<li>Helianti Hilman, JAVARA Indonesia</li>
		<li>Dante de Lima</li>
		<li>Andry Lim</li>
		<li>Arestina Salinas Morados, Pamora Farm, Inc.</li>
		<li>Mon Peñalosa, Peñalosa Farms</li>
		<li>Dr. Danilo Abayon, ACAP</li>
		<li>Hindy Tantoco-Weber, Holy Carabao</li>
		<li>Melanie Teng-Go, Holy Carabao</li>
		<li>Hon. Junaflor "Sweet" Cerilles, Mayor and Community Leader</li>
		<li>Gigi Pontejos-Morris, MoCA Family Farm Learning Center</li>
		<li>Rhodora Palomar-Fresnedi, Sunshine Farm Philippines</li>
		<li>Dr. Jaime Aristotle Alip, Cardbank - MRI</li>
		<li>Simon Bakker, Kennemer Foods</li>
	</ul>
</div>
<h3 role="heading" aria-level="3" class="font-title uppercase text-2xl text-gray-900 dark:text-gray-100 leading-tight mb-3">Agritech</h3>
<div class="mb-6">
	<ul>
		...
		<li>Elizabeth Hernandez, Corteva</li>
		<li>Johan Janssens, Joomla!</li>
		<li>Paul Voutier, Grow ASIA</li>
		<li>Angus Yip, Vagrant Limited</li>
		<li>Priya Thachadi, Villgrow</li>
		<li>Zes Martinez, FAME Systems</li>
		<li>Roger Barroga, PhilRice</li>
		<li>Julius Barcelona, Harbest</li>
		<li>Dr. Thanh My Nguyen, Rynan Smart Fertilizers</li>
		<li>Antonio Causing, Leonie Agri Corporation (Pascual Laboratories)</li>
		<li>Rex Puentespina, Malagos Chocolates</li>
		<li>Bobby Amores, Phil Export</li>
		<li>Johan Boden, TAEL Partners</li>
	</ul>
</div>
<h3 role="heading" aria-level="3" class="font-title uppercase text-2xl text-gray-900 dark:text-gray-100 leading-tight mb-3">Agritourism</h3>
<div class="mb-6">
	<ul>
		<li>Gina Lopez, iLOVE Foundation</li>
		<li>Josephine Costales, Costales Nature Farms</li>
		<li>Jeanie Javelosa, Great Women ASEAN and Echostore</li>
		<li>Catherine Brillantes-Turvill, Nature Wellness Village</li>
		<li>Thomas Murillo &amp; Thelma Murillo, Gorgeous Farms + The Wild Juan</li>
		<li>Eric Atanacio, Terra Verde Ecofarm</li>
		<li><em>Prof. Willy Arcilla, Business Mentors, Inc.</em></li>
	</ul>
</div>
<h3 role="heading" aria-level="3" class="font-title uppercase text-2xl text-gray-900 dark:text-gray-100 leading-tight mb-3">Other speakers</h3>
<div class="mb-6">
	<ul>
		<li>Kal Joffres, Tandemic</li>
		<li>Miguel Lopez, Go Negosyo</li>
		<li>Chef Jam Melchor, Slow Food Youth Network</li>
		<li>Kalel Ervin Demetrio</li>
		<li>James Flanagan, Strategic Commons</li>
		<li>Joshua Gilbert, PriceWaterhouseCoopers Indigenous Consulting</li>
	</ul>
</div>
<h3 role="heading" aria-level="3" class="font-title uppercase text-2xl text-gray-900 dark:text-gray-100 leading-tight mb-3">LEAF 2018 Speakers In Focus</h3>
