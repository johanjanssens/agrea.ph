...
<h2 role="heading" aria-level="2" class="font-title text-3xl uppercase text-gray-900 leading-none mb-2">Global Advisory Board in Focus</h2>
...
<div class="grid xl:grid-cols-3 md:grid-cols-2 gap-8 mt-4 mb-6">
	...
	<div class="bg-gray-100 p-6 rounded-lg"><img alt="Jean-Marc Debricon" class="h-64 rounded w-full object-cover object-center mb-6" src="images://events/leaf/board/debricon.jpg" /></div>
	<div class="bg-gray-100 p-6 rounded-lg"><img alt="Joshua Gilbert" class="h-64 rounded w-full object-cover object-center mb-6" src="images://events/leaf/board/gilbert.jpg" /></div>
	<div class="bg-gray-100 p-6 rounded-lg"><img alt="James Flanagan" class="h-64 rounded w-full object-cover object-center mb-6" src="images://events/leaf/board/flanagan.jpg" /></div>
	<div class="bg-gray-100 p-6 rounded-lg"><img alt="Durrie Hassan" class="h-64 rounded w-full object-cover object-center mb-6" src="images://events/leaf/board/hassan.jpg" /></div>
	<div class="bg-gray-100 p-6 rounded-lg"><img alt="Kal Joffres" class="h-64 rounded w-full object-cover object-center mb-6" src="images://events/leaf/board/joffres.jpg" /></div>
