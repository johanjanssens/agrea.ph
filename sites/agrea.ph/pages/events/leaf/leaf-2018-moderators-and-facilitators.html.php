...
<div class="flex flex-col sm:flex-row">
	...
	<ktml:images max-width="33%" lazyload="progressive,inline">
		<div class="flex flex-wrap w-full mb-10">
			<div class="lg:w-2/3 w-full mb-6 lg:mb-0">
				<h1 class="sm:text-5xl text-4xl font-medium font-title uppercase mb-2 text-gray-900 dark:text-gray-100 leading-none leading-tight"><?= $title; ?></h1>
				<div class="h-1 w-20 bg-brand rounded"></div>
			</div>
		</div>
		<ul>
			<li>Cherrie De Erit Atilano, AGREA</li>
			<li>Ginggay Hontiveros-Malvar, Kapatid Agri Mentor Me</li>
			<li>Carlo Sumaoang, MNLGrowkits</li>
			<li>Bryan Benitez McClelland, Bamb Ecological Technology, Inc.</li>
			<li>Jeannie Javelosa</li>
			<li>Quintin Pastraña, WEnergy Power Pilipinas</li>
			<li>Ralph Becker, Urban Greens</li>
			<li>Enzo Pinga, Earthbeat Farms</li>
			<li>Raphael Teraoka Dacones, Teraoka Family Farm</li>
			<li>Ces Oreña-Drilon, Filipino Broadcast Journalist</li>
		...
		<h3 role="heading" aria-level="3" class="text-gray-900 font-medium font-title uppercase my-4 leading-tight">LEAF 2018 Moderators In Focus</h3>
	...
	<aside role="complementary" class="sm:w-1/4 sm:mt-0 ms:pt-0 sm:pl-8 sm:pb-8 sm:border-l sm:mt-0 border-gray-300 sm:border-t-0 border-t mt-4 pt-4">
		...
		<h3 role="heading" aria-level="3" class="font-medium font-title uppercase mt-4 text-gray-900 dark:text-gray-100 text-lg leading-tight">Related links:</h3>
		<div class="w-12 h-1 bg-brand rounded mt-2 mb-4"></div>
