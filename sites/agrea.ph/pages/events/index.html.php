...
<div class="flex flex-col sm:flex-row">
	<div role="main" class="sm:w-3/4 sm:pr-8 sm:pt-4 sm:pb-4">
		...
		<div role="grid" class="grid xl:grid-cols-3 md:grid-cols-2 gap-8 mb-8">
			...
			<a class="bg-gradient-to-b from-gray-50 to-gray-100 hover:from-lime-500 hover:to-lime-600 transition duration-300 ease-in-out text-gray-900 dark:text-gray-100 hover:text-dark-green-500 p-6 rounded-lg" href="<?= route('events/article', ['slug' => $article->slug]) ?>">
				<aside role="gridcell">
