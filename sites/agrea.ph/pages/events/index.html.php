...
<div class="flex flex-col sm:flex-row">
	<div role="main" class="sm:w-3/4 sm:pr-8 sm:pt-4 sm:pb-4">
		...
		<div role="grid" class="grid xl:grid-cols-3 md:grid-cols-2 gap-8 mb-8">
			...
			<a role="gridcell" class="bg-gray-100 hover:bg-lime-500 transition duration-300 ease-in-out text-gray-900 hover:text-dark-green-500 p-6 rounded-lg" href="<?= route('events/article', ['slug' => $article->slug]) ?>">
	...
	<ktml:images max-width="25%" lazyload="progressive,inline">
		...
		<h3 role="heading" aria-level="3" class="font-medium font-title mt-4 text-gray-900 text-lg">Partner Events</h3>
		<div class="w-12 h-1 bg-green-500 rounded mt-2 mb-4"></div>
		...
		<h2 role="heading" aria-level="2" class="text-lg text-gray-900 font-medium font-title mb-4 leading-tight"><a class="text-gray-900 hover:text-gray-600" href="https://www.facebook.com/agreaph/photos/a.1580538318877949/2390153167916456/?type=3&amp;theater&amp;_rdc=1&amp;_rdr">Magna Carta of Rural Women: Round Table on Gender Equity &amp; Empowerment</a></h2>
		...
		<h2 role="heading" aria-level="2" class="text-lg text-gray-900 font-medium font-title mb-4 leading-tight"><a class="text-gray-900 hover:text-gray-600" href="https://web.facebook.com/agreaph/photos/a.1580538318877949.1073741827.1573291842935930/2119894528275656/?type=3&amp;theater">Balar Weekend Flea Market</a></h2>
	</ktml:images>
	</aside>
</div>
