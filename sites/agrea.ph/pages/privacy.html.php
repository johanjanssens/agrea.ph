...
<article role="main" itemscope itemtype="http://schema.org/Article">
	...
	<div class="max-w-4xl m-auto mt-8">
		...
		<p>This Policy is incorporated into and part of Agrea Master Terms of Use (“Master Terms”) located at <a href="/terms">https://www.agrea.ph/terms</a>.</p>

		<p>Unless otherwise noted on a particular website or service hosted by Agrea, this Policy describes and governs the information collection, use, and sharing practices of Agrea with respect to your use of our websites that link to this Privacy Policy, including: <a href="/">https://www.agrea.ph</a> (collectively, the “Websites”), and the services we provide through our Websites and/or host on our servers, including without limitation the license chooser, legal tools, search engine, the Agrea Login Services (defined below), and the Agrea community website (collectively, the Websites, and the services available through them are referred to as the “Services”).</p>

		<p>Before you use or submit any information through or in connection with the Services, please carefully review this Privacy Policy. By using any part of the Services, you understand that your information will be collected, used, and disclosed as outlined in this Privacy Policy. IF YOU DO NOT AGREE TO THIS PRIVACY POLICY, PLEASE DO NOT USE THE SERVICES.</p>

		<h3>1. Our Principles</h3>

		<p>Agrea has designed this policy to be consistent with the following principles:</p>
		...
		<h5>Device/Usage Information</h5>
		...
		<ul>
			...
			<li>Evaluate your application for a scholarship, grant, fellowship, or Agrea membership;</li>
			<li>Distribute funds to scholarship and grant recipients;</li>
			<li>Provide and improve the Services, including to develop new features or services, promote Agrea community collaboration, take steps to secure the Services, and for technical and customer support;</li>
			<li>Fundraise, accept donations, or process purchases of Agrea merchandise;</li>
			<li>Host events and programs such as the annual Agrea Summit or the Agrea Certificate course;</li>
			<li>Send you information about your relationship or transactions with us, account alerts, or other communications, such as newsletters to which you have subscribed;</li>
			...
			<li>Evaluate job candidates during our hiring process;</li>
			<li>Comply with the law and protect the safety, rights, property, or security of Agrea, the Services, our users, and the general public; and</li>
			<li>Enforce our <a href="/terms">Master Terms</a>, including to investigate potential violations thereof.</li>
		</ul>
		...
		<h3>4. When We Disclose Your Information</h3>

		<p>We may disclose and/or share your information under the following circumstances:</p>

		<h5>Service Providers</h5>

		<p>We may disclose your information with third parties who perform services on our behalf, including without limitation, event management, candidate selection, marketing, customer support, data storage, data analysis and processing, and legal services.</p>

		<p>For example, when you apply for a scholarship, grant, fellowship, or to be selected to participate in one of our other programs, Agrea may share that information with the individuals designated to select participants in, and help manage, those programs, which may include people not employed by Agrea.</p>

		<p>Or, when you register for an event, we may share your information with vendors, third party contractors, partner organizations, and volunteers for the purpose of organizing and running the event and related activities.</p>

		<h5>Legal Compliance and Protection of Agrea and Others.</h5>

		<p>We may disclose your information if required to do so by law or on a good faith belief that such disclosure is permitted by this Privacy Policy or reasonably necessary or appropriate for any of the following reasons: (a) to comply with legal process; (b) to enforce or apply our Master Terms and this Privacy Policy, or other contracts with you, including investigation of potential violations thereof; (c) enforce our Charter including the Code of Conduct and policies contained and incorporated therein, (d) to respond to your requests for customer service; and/or (e) to protect the rights, property, or personal safety of Agrea, our agents and affiliates, our users, and the public. This includes exchanging information with other companies and organizations for fraud protection, and spam/malware prevention, and similar purposes.</p>

		<h5>Business Transfers.</h5>

		<p>As we continue to develop our business, we may engage in certain business transactions, such as the transfer or sale of our assets. In such transactions, (including in contemplation of such transactions, e.g., due diligence) your information may be disclosed. If any of Agrea’s assets are sold or transferred to a third party, customer information (including your email address) would likely be one of the transferred business assets.</p>
		...
		<h5>Aggregate/De-identified Information.</h5>
		...
		<ul>
			<li>To Honor Our Contractual Commitments to You. Much of our processing of information is to meet our contractual obligations to provide services to our users.</li>
			<li>Legitimate Interests. In many cases, we handle information on the ground that it furthers our legitimate interests in ways that are not overridden by the interests or fundamental rights and freedoms of the affected individuals, these include:
				<ul>
		...
		<ul>
			<li>Email Unsubscribe – You may unsubscribe from our marketing emails at any time by clicking on the “unsubscribe” link at the bottom of each newsletter or by emailing legal@agrea.ph with your request.</li>
			<li>Fundraising Analytics – You may opt out of CC’s fundraising analytics activities by contacting legal@agrea.ph with your request.</li>
			<li>Account Preferences – If you have registered for an account with us through our Services, you can update your account information or adjust your email communications preferences by logging into your account and updating your settings.</li>
			<li>EU Data Subject Rights – Individuals in the European Economic Area (“EEA”) and other jurisdictions have certain legal rights (subject to applicable exceptions and limitations) to obtain confirmation of whether we hold certain information about them, to access such information, and to obtain its correction or deletion in appropriate circumstances. You may have the right to object to our handling of your information, restrict our processing of your information, and to withdraw any consent you have provided. To exercise these rights, please email us at legal@agrea.ph with the nature of your request. You also have the right to go directly to the relevant supervisory or legal authority, but we encourage you to contact us so that we may resolve your concerns directly as best and as promptly as we can.</li>
		</ul>

		<h3>8. International Transfers</h3>

		<p>Our computer systems are currently based in the United States and the United Kingdom and the majority of our contractors are based in the United States or Canada. As described above in the “When We Disclose Your Information” section, we may share your information with trusted service providers or business partners in countries other than your country of residence, including the United States, in accordance with applicable law. This means that some of your information may be processed in the United States, which may not offer the same level of protection as the privacy laws of your jurisdiction. By providing us with your information, you acknowledge any such transfer, storage or use.</p>
		...
		<h3>14. Questions About this Privacy Policy</h3>

		<p>If you have any questions about this Privacy Policy or our privacy practices, you can contact us at: legal@agrea.ph.</p>
	</div>
</article>