...
<section class="text-gray-700 mb-24">
  ...
  <div role="complimentary" class="container px-5 py-12 mx-auto bg-gradient-to-b from-dark-green-100 to-dark-green-200 rounded">
    ...
    <div class="grid xl:grid-cols-4 sm:grid-cols-2 md:grid-cols-3 gap-4">
      ...
      <a class="bg-gradient-to-b from-gray-50 to-gray-100 hover:from-lime-500 hover:to-lime-600 transition duration-300 ease-in-out text-gray-900 dark:text-gray-100 hover:text-dark-green-500 p-6 rounded-lg" href="<?= route(page('news/article'), ['slug' => $newSprout->slug]) ?>">
        <aside>
    ...
    <div class="flex flex-col sm:flex-row mt-10">
      ...
      <div class="sm:w-2/3 sm:pl-8 sm:pt-4 sm:pb-2 sm:border-l border-gray-300 sm:border-t-0 border-t mt-4 sm:mt-0 text-center sm:text-left">
        ...
        <? foreach (data('weblinks')->shuffle()->slice(0, 4) as $weblink) : ?>
          <a class="bg-gradient-to-b from-gray-50 to-gray-100 hover:from-lime-500 hover:to-lime-600 transition duration-300 ease-in-out text-gray-900 dark:text-gray-100 hover:text-dark-green-500 p-6 rounded-lg" href="<?= $weblink->url; ?>">
            <aside>
              <div class="rounded-lg h-64 overflow-hidden">
