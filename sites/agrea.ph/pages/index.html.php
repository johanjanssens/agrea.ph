...
<section class="text-gray-700">
  ...
  <div class="flex flex-wrap w-full mb-10">
    <div class="w-full mb-6 lg:mb-0">
      <h2 role="heading" aria-level="2" class="sm:text-5xl text-4xl font-medium font-title mb-2 text-gray-900 leading-none">Farm schools, fora and reports</h2>
      <div class="h-1 w-20 bg-green-500 rounded"></div>
    </div>
  </div>
    <div class="flex flex-wrap sm:-m-4 -mx-4 -mb-10 -mt-4">
      <aside class="p-4 md:w-1/3 sm:mb-0 mb-6">
        ...
        <h3 role="heading" aria-level="3" class="text-xl font-medium font-title text-gray-900 mt-5">Learn organic farming the AGREA way</h3>
      ...
      <aside class="p-4 md:w-1/3 sm:mb-0 mb-6">
        ...
        <h3 role="heading" aria-level="3" class="text-xl font-medium font-title text-gray-900 mt-5">Leaders and Entrepreneurs in Agriculture Forum</h3>
      ...
      <aside class="p-4 md:w-1/3 sm:mb-0 mb-6">
        ...
        <h3 role="heading" aria-level="3" class="text-xl font-medium font-title text-gray-900 mt-5">LEAF 2018 Terminal Report</h3>
    ...
    <div class="flex flex-col sm:flex-row mt-10">
      <div class="sm:w-1/3 sm:pr-8 sm:py-8">
        <div class="flex flex-col justify-center">
          <h2 role="heading" aria-level="2" class="font-medium font-title mt-4 text-gray-900 text-lg leading-tight">Fresh picks from the AGREA Farm</h2>
      ...
      <div class="sm:w-2/3 sm:pl-8 sm:py-8 sm:border-l border-gray-300 sm:border-t-0 border-t mt-4 pt-4 sm:mt-0 text-center sm:text-left">
        <div class="flex flex-wrap w-full mb-10">
          <div class="w-full mb-6 lg:mb-0">
            <h2 role="heading" aria-level="2" class="sm:text-5xl text-4xl font-medium font-title mb-2 text-gray-900 leading-none">Agrea in the news</h2>
            <div class="h-1 w-20 bg-green-500 rounded"></div>
          </div>
        </div>
