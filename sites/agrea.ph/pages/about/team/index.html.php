	...
	<div role="main" class="sm:w-3/4 sm:pr-8 sm:pt-4 sm:pb-4">
		...
		<div role="grid" class="grid xl:grid-cols-3 md:grid-cols-2 gap-8 mb-8">
			<? foreach (data('team') as $member) : ?>
				<? if ($member->slug !== ""): ?>
				<a class="bg-gray-100 hover:bg-lime-500 transition duration-300 ease-in-out text-gray-900 dark:text-gray-100 hover:text-dark-green-500 p-6 rounded-lg" href="/about/team/<?= $member->slug; ?>">
					<aside role="gridcell">
				<? else: ?>
