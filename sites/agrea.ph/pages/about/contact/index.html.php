    ...
    <ktml:images max-width="80%">
        <div class="flex flex-wrap w-full mb-10">
            ...
            <div class="lg:w-1/2 md:block hidden w-full">
                <img class="md:h-32 rounded w-full object-cover object-center" src="images://contact/contact-agrea.jpg" alt="<?= $title ?>" data-max-width="50%" data-lazyload="progressive,inline">
            </div>
        </div>
