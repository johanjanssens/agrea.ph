<section class="relative hero-alt <?= $class ?>">
  <div class="container m-auto">
    ...
    <div class="md:flex md:justify-center md:w-1/2 py-24 sm:py-36 md:py-42 md:mx-0 mx-8">
  ...
  <div class="hero-image hidden md:block absolute top-0 right-0 z-10 h-full w-1/2">
      <div style="background-image: url(<?= $articles->image->url ?>);background-position:right;" class="h-full object-cover">
