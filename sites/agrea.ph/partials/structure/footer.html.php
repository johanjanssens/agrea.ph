    ...
    <div class="container mx-auto flex flex-row items-center px-5 pt-6 border-box">
      ...
      <span class="inline-flex sm:ml-auto sm:mt-0 mt-4 justify-center sm:justify-start">
        <span class="inline-flex mr-2 bg-green-500 rounded border-green-900 border p-2 -mt-2">
          ...
          <a href="https://www.instagram.com/agreaphl/" title="Follow our instagram" class="ml-3 text-gray-200 hover:text-dark-green-600 transition duration-300 ease-in-out">
            <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-5 h-5" viewBox="0 0 24 24">
              <rect width="20" height="20" x="2" y="2" rx="5" ry="5"></rect>
              <path d="M16 11.37A4 4 0 1112.63 8 4 4 0 0116 11.37zm1.5-4.87h.01"></path>
            </svg>
          </a>
          <a href="https://www.twitter.com/agreaphl" title="Follow us on twitter" class="ml-3 text-gray-200 hover:text-dark-green-600 transition duration-300 ease-in-out">
            <svg fill="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-5 h-5" viewBox="0 0 24 24">
              <path d="M23 3a10.9 10.9 0 01-3.14 1.53 4.48 4.48 0 00-7.86 3v1A10.66 10.66 0 013 4s-4 9 5 13a11.64 11.64 0 01-7 2c9 5 20 0 20-11.5a4.5 4.5 0 00-.08-.83A7.72 7.72 0 0023 3z"></path>
            </svg>
          </a>
          <span class="text-gray-200 text-xs border-dark-green-600 border-l pl-2 ml-3">Follow our social feeds</span>
        </span>
        <span class="sm:text-sm text-xs text-gray-500 sm:ml-6 sm:mt-0 mt-4">Built by</span>
