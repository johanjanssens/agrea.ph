<footer class="text-gray-700 text-base body-font" style="background-image: url(<?= $footer['image'].'?q=25' ?? 'images://background/rice-farmer.jpg?q=25' ?>);">
    ...
    <div class="container mx-auto flex flex-row items-center justify-between px-5 md:pt-6 pt-3 border-box">
      ...
      <span class="inline-flex sm:ml-auto sm:mt-0 mt-4 justify-center sm:justify-start">
        ...
        <span itemscope itemtype="http://schema.org/Organization" class="inline-flex mx-2 -mt-2">
          ...
          <a itemprop="sameAs" href="https://www.instagram.com/agreaphl/" title="Follow our instagram" class="bg-green-500 rounded border-green-900 border p-1 ml-1 text-gray-900 hover:bg-green-200 transition duration-500 ease-in-out">
